...
class Obligation(Base):
    ...
    id          = Column(String, primary_key=True)   # {sid_prefix}-OBL-001 style
...
class GapAnalysis(Base):
    ...
    id                  = Column(String, primary_key=True)   # {sid_prefix}-GAP-001
    session_id          = Column(String, ForeignKey("workspace_sessions.id"))
    obligation_id       = Column(String, ForeignKey("obligations.id"))
...
class PolicyPullRequest(Base):
    ...
    id                  = Column(String, primary_key=True)   # {sid_prefix}-PPR-001
    session_id          = Column(String, ForeignKey("workspace_sessions.id"))
    obligation_id       = Column(String, ForeignKey("obligations.id"))
    title               = Column(String)
